...
try {
    ...
    $manifest = [ordered]@{
        ...
        notes = "Curadoria das categorias com figuras claras, listas reduzidas e remocao de estimulos repetidos."
...
<body>
  <main>
    <h1>FonoLousa</h1>
    <p>Versao 1.0.25 de teste para instalacao em tablet Android.</p>
